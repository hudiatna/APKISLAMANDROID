...
public class JadwalSholatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spKota.setOnItemSelectedListener(new
    ...
    private void loadKota() {
        try {
            String api = "/kota";
            ClientAsyncTask task = new ClientAsyncTask(this, api, new
                ...
                ClientAsyncTask task = new ClientAsyncTask(this, api_url, new
                        ClientAsyncTask.OnPostExecuteListener() {
                            ...
                            public void onPostExecute(String result) {
                                ...
                                try {
                                    JSONObject jsonObj = new JSONObject(result);
                                    JSONObject objJadwal =
                                            jsonObj.getJSONObject("jadwal");
                                    ...
                                    Log.d("dataJadwal", result.toString());
                                } catch (JSONException e) {
                                    e.printStackTrace();
                                }
                            }
